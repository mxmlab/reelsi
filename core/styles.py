...
Поля пресета (все опциональны, чего нет — берётся из «Базового»):
  ...
  back_step      шаг строки заднего плана, доля от обычного шага (дефолт 0.65, 1.0 = как все)
...
BASE = {
    ...
    "back_step": 0.65,                     # шаг строки заднего плана, доля от обычного шага (дефолт 0.65, 1.0 = как все)
