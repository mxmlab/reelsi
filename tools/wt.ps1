...
работа исчезает из-под рук (так и случилось 2026-08-14: чужие незакоммиченные
правки уехали в stash, и вторая сессия встала посреди работы). Лечится не
договорённостями, а отдельной рабочей копией на сессию: общий `.git`, свои файлы.
