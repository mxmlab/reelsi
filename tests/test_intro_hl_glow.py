...
"""Свечение жёлтого хайлайта интро с тритоном.

Что проверяем (10 случаев из раздела «Как проверить»):
...
Цвет выделения у случаев с тритоном — тёмный (DARK_HL_FILL): на ярком цвете
...
# Тёмный цвет выделения для случаев с тритоном: красный, яркость мидтонов
