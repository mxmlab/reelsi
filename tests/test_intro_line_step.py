...
"""Межстрочный интервал интро: ползунок intro_line_step.
...
его убрало). Теперь ключ стиля intro_line_step (%) даёт ОДИН множитель
...
Шаг заднего плана — line_step * back_step, то есть тот же множитель (
...
def test_step_k_scales_back_steps():
    ...
    (минимума по чернилам в формуле больше нет)."""
    h = 1920.0
