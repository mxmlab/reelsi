...
RUN pip install --no-cache-dir flask numpy scipy soundfile pytest pytest-timeout pytest-cov ruff "mypy>=2.3,<3" fonttools "pillow>=10.0" pyarrow "zstandard>=0.22"
WORKDIR /src
