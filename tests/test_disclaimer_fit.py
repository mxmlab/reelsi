...
"""Дисклеймер подстраивается под шрифт (задание E): кегль по ширине, шаг строк по буквам.
...
глифов (`fonts.ink_extent`, как у строк интро в задании A1) и отдаёт в .jsx готовым
