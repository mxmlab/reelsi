...
Здесь:
  ...
  5. ручки intro_big_gap, intro_big_step и intro_big_over: подписи, диапазоны, дефолты и
     ...
     cap первой строки на шрифте фикстуры (Oswald-Regular), числами;
  ...
  8. масштаб появления — ключи ОТ БАЗЫ слоя: база = Scale, выставленный до
...
и в CI геометрия «большого слева» не проверялась вовсе.
"""
import gzip
import json
import os
