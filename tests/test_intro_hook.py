...
"""Хук ИИ-интро: строки по 1–2 слова и разбиение на прекомпы (задание BF, 2026-08-14).
...
def test_split_words_не_оставляет_предлог_в_конце_куска():
    ...
    оставлял «С» последним в куске (задание BF2, 2026-08-14)."""
...
def test_intro_defunc_не_оставляет_предлог_в_конце_строки():
    ...
    слово из следующей строки назад (задание BF2, 2026-08-14)."""
